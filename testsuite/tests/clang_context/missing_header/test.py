"""
Check that the clang_context matcher behaves correctly on sources
which require a header to properly parse
"""
...
run_cli(
    [
        cli_arg_for_entry_update(
            identifier="missing_header",
            kind="clang_context",
            filename="foo.cpp",
            span=LocationSpan(Location(10, 5), Location(10, 50)),
...
check_single_match(
    cpp_matches, "foo.cpp", LocationSpan(Location(10, 5), Location(10, 50))
)
